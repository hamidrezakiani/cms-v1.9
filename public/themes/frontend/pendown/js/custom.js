var News360 = function(){
	...
	var handleResizeElement = function(){
	    setTimeout(function(){
			...
			if($('.header .header-center-box').length > 0 )
			{
				headerLogoCenter = $('.header .header-center-box').outerHeight();
			}			
				
			if($('.header .main-bar').length > 0 )
			{
				headerNav = $('.header .main-bar').outerHeight();
			}	
			
			var headerHeight = parseInt(headerNav) + parseInt(headerTop) + parseInt(headerLogoCenter);
