	...
	<div class="row page-titles mx-0 mb-3">
		<div class="col-sm-6 p-md-0">
			<div class="welcome-text">
				<h4>{{ __('common.notifications_config') }}</h4>
				<span>{{ __('common.add_notification_config') }}</span>
			</div>
		</div>
	...
	<div class="card">
		...
		@csrf
			<div class="card-body">
				...
				<div class="row">
					<div class="col-md-12">
						<label><input type="checkbox" name="notification_types[1]" class="EnableNotificationBox" rel="EmailNotificationSec" @checked(old('notification_types.1'))> {{ __('common.email_notification') }}</label>
					...
					<div class="col-md-12">
						<label><input type="checkbox" name="notification_types[2]" class="EnableNotificationBox" rel="WebNotificationSec" @checked(old("notification_types.2"))> {{ __('common.web_notification') }}</label>
					...
					<div class="col-md-12">
						<label><input type="checkbox" name="notification_types[3]" class="EnableNotificationBox" rel="SMSNotificationSec" @checked(old("notification_types.3"))> {{ __('common.sms_notification') }}</label>
