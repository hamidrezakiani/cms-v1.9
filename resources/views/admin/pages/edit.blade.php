	...
	<div class="row page-titles mx-0">
        <div class="col-sm-6 p-0">
            <div class="welcome-text">
                <h4>{{ __('common.pages') }}</h4>
                <span>{{ __('common.edit_page') }}</span>
            </div>
        </div>
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								...
								<button type="button" class="shadow-none btn btn-primary btn-sm" id="UseMagicEditor" use_editor="{{ (Str::contains($page->content , ['%ME%', '%ME-EL%'])) ? 'true' : 'false' }}"><i class="fa fa-list"></i> {{ __('common.use_magic_editor') }}</button>
							</div>
