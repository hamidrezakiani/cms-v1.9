                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <input type="url" name="app_url"  class="form-control" id="app_url" value="{{ old('app_url', env('APP_URL') ) }}" placeholder="{{ __('common.app_url') }}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="log_level">{{ __('common.app_log_level') }}</label>
                                                    <select name="log_level" class="form-control default-select" id="log_level">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <input type="asset_url" name="asset_url" class="form-control" id="asset_url" value="{{ old('asset_url', env('ASSET_URL')) }}" placeholder="{{ __('common.asset_url') }}">
