                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control MakeSlug" id="BlogTitle" placeholder="{{ __('common.title') }}" value="{{ old('title', $blogTag->title) }}" rel="slug" required>
                                        @error('title')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="slug" class="form-control" id="slug" placeholder="{{ __('common.slug') }}" value="{{ old('slug', $blogTag->slug) }}" required>
                                        @error('slug')
                                            <div class="invalid-feedback d-block">
                                                {{ $message }}
                                            </div>
