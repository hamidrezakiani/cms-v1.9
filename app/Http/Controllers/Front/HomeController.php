    ...
    public function detail(Request $request)
    {
        ...
        if(!empty($blog) && empty($request->page_id))
        {
            ...
            if($single)
            {
                ...
                return view('single', compact('blog', 'blogs','blog_categories','status', 'blogMeta', 'seoMeta', 'comments'));
            }
        ...
        else
        {
            ...
            }])->where($where)->where('status', '!=', '3')->firstOrFail();
            ...
            return view('page', compact('page','blog','status', 'comments', 'seoMeta', 'pageSeo'));
        }
