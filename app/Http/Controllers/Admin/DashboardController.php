...
class DashboardController extends Controller
{
    ...
    */
    ...
    {   
        ...
        $users_query = User::selectRaw('CONCAT_WS("-", DATE_FORMAT(created_at, "%b"),YEAR(created_at)) monthyear, count(*) data');
        $users = $users_query->groupBy('monthyear')->orderBy('monthyear', 'asc')->get();
