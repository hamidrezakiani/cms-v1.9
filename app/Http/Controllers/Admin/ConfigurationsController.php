...
class ConfigurationsController extends Controller
{
    ...
    **/
    ...
    public function admin_reading(Request $request) {
        ...
        return view('admin.configurations.admin_reading_prefix', compact('prefix', 'pages', 'configurations','mainLanguageList','mainLanguageListSort'));
    }
