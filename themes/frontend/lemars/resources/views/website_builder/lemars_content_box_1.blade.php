        ...
        <div class="row">
            <div class="col-md-12">
                <div class="text-center section-head">
                    <h1 class="title-head1">{{ isset($args['title']) ? $args['title'] : '' }}</h1>
                </div>
                <div class="alignwide">
                    <figure class="aligncenter">
                        @if(isset($args['image']) && !empty($args['image']))
                            <img src="{{ asset('storage/page-images/magic-editor/'.$args['image']) }}" alt="{{ __('content Image') }}">
                        @else
                            <img src="{{ asset('images/noimage.jpg') }}" alt="{{ __('content Image') }}">
                        @endif
                    </figure>
                </div>
                    ...
                    <div class="dlab-post-info">
                        <div class="dlab-post-text text">
                            <div class="row text-justify">
                                <div class="col-lg-6">
                                    <p>{{ isset($args['content1']) ? $args['content1'] : '' }}</p>
                                </div>
                                <div class="col-lg-6">
                                    <p>{{ isset($args['content2']) ? $args['content2'] : '' }}</p>
                                </div>
                            </div>
