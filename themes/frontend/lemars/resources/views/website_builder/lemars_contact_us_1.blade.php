            ...
            <div class="col-lg-12 col-md-12">
                ...
                <div class="banner-contact">
                    @if(isset($args['image']) && !empty($args['image']))
                        <img src="{{ asset('storage/page-images/magic-editor/'.$args['image']) }}" alt="{{ __('Contact Image') }}">
                    @else
                        <img src="{{ asset('images/noimage.jpg') }}" alt="{{ __('Contact Image') }}">
                    @endif
                </div>
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-4 m-b30">
                        <div class="contact-info">
                            <div class="extra-info">
                                ...
                                <ul>
                                    <li><i class="la la-location-arrow"></i> {{ isset($args['address']) ? $args['address'] : '' }}</li>
