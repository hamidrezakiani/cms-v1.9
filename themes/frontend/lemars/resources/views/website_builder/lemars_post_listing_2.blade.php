...
<div class="section-full bg-white content-inner-1">
    ...
    <div class="min-container">
            ...
            <div class="col-lg-6 d-flex">
                <div class="blog-card center text-center bg-dark w-100 m-b30">
                    <div class="blog-card-info text-white">
                        ...
                        <h4 class="title">{{ isset($blogs[0]['title']) ? Str::limit($blogs[0]['title'], 24, ' ...') : '' }}</h4>
                        <p>{{ isset($blogs[0]['excerpt']) ? Str::limit($blogs[0]['excerpt'], 60, ' ...') : '' }}</p>
                        @php
        ...
        <div class="sep-bottom">
            <div class="row" id="ajaxLoadMoreContainer">
