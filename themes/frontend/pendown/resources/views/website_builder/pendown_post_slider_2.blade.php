...
<div class="section-full trending-post-bx wow fadeIn" data-wow-duration="2s" data-wow-delay="0.6s">
			...
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide">
					<div class="trending-post">
						...
						<div class="dlab-info">
							<h6 class="dlab-title"><a href="{{ DzHelper::laraBlogLink($blog->id) }}">{{ isset($blog->title) ? Str::limit($blog->title, 30, ' ...') : '' }}</a></h6>
							<div class="dlab-meta">
								<ul>
									<li class="post-category"><a href="javascript:void(0);">{{ isset($blog->blog_categories[0]) ? $blog->blog_categories[0]['title'] : '' }}</a></li>
...
@push('inline-swiper')
    <script>
		...
		var breakpoint1 = {{ isset($args['breakpoint1']) ? $args['breakpoint1'] : 1.5 }};
        var breakpoint2 = {{ isset($args['breakpoint2']) ? $args['breakpoint2'] : 2 }};
        var breakpoint3 = {{ isset($args['breakpoint3']) ? $args['breakpoint3'] : 3 }};
        var breakpoint4 = {{ isset($args['breakpoint3']) ? $args['breakpoint3'] : 3 }};
        var breakpoint5 = {{ isset($args['breakpoint4']) ? $args['breakpoint4'] : 4 }};
        var break_points = {};
