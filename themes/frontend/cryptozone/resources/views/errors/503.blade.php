            ...
            <div class="row justify-content-center h-100 align-items-center">
                <div class="col-md-5">
                    <div class="form-input-content text-center error-page">
                        <h1 class="error-text fw-bold text-dark">{{ __('503') }}</h1>
                        <h4><i class="fa fa-times-circle text-danger"></i> {{ __('Service Unavailable') }}</h4>
                        <p class="text-dark">{!! config('Site.maintenance_message') !!}</p>
						<div>
