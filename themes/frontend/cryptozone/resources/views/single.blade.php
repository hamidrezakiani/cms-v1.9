...
@section('content')
    ...
    <div class="section-full content-inner bg-white">
        <div class="container">
            <div class="row">
            @if($blog)
                <div class=" {{ DzHelper::dzHasSidebar() ? 'col-lg-8 col-md-7 col-12' : 'col-12' }}">
                                ...
                                <div class="col-lg-6 m-b30">
                                    <div class="dz-card style-1 blog-lg overlay-shine">
                                        ...
                                        <div class="dz-info">
                                            ...
                                            @endphp
                                            <h4 class="dz-title"><a href="{{ DzHelper::laraBlogLink($related_blog->id) }}">{{ $related_blog_visibility }}{{ Str::limit($related_blog->title, 25, ' ...') }}</a></h4>
                                            <p>{{ Str::limit($related_blog->excerpt, 60, ' ...') }}</p>
                                            <a href="{{ DzHelper::laraBlogLink($related_blog->id) }}" class="btn btn-primary">{{ __('Read More') }}</a>
                                        </div>
                                    </div>
                                </div>
                            @empty
                                ...
                                <div id="ReplyFormContainer">
                                    ...
                                    <h5>
                                        ...
                                        <small class="fw-normal"> 
                                            <a rel="nofollow" class="d-none" id="cancel-comment-reply" href="{{ DzHelper::laraBlogLink($blog->id) }}#respond">
                                                {{ __('Cancel reply') }}
                                            </a>
                                         </small>
                                    </h5>
