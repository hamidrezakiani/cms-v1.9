@php
	$bg_dark = isset($bg_dark) ? $bg_dark : '';
	$transparent = isset($transparent) ? $transparent : 'header-transparent';
@endphp
<header class="site-header mo-left header-full header {{ $bg_dark }} {{ $transparent }}">
	<!-- Main Header -->
